...
route
  ...
  .get(
    ...
    initCart.initCart,
    initCart.initWishlist,
    mainController.wishlist
  );

route
  .route("/add_cart")
  .post(initCart.initCart, initCart.initWishlist, mainController.add_cart);
...
route.post(
  ...
  [
    [
      ...
      check("checkbox")
        .notEmpty()
        .withMessage("You have to accept term and condition"),
    ],
  ],
  async (req, resp) => {
